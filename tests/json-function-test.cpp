...
struct CallFunction
{
  ...
  JS_FUNCTION_CONTAINER(JS_FUNCTION(execute_one), JS_FUNCTION(execute_two), JS_FUNCTION(execute_three));
...
TEST_CASE("simpleTestRegular", "[function]")
{
  CallFunction cont;
  std::string json_out;
...
TEST_CASE("TestRegularFunction", "[function]")
{
...
TEST_CASE("virtualFunctionTestRegular", "[function]")
{
  std::string json_out;
...
TEST_CASE("super_class_param_testRegular", "[function]")
{
...
struct CallVoidStruct
{
  ...
  JS_FUNCTION_CONTAINER(JS_FUNCTION(call_void), JS_FUNCTION(call_void_context), JS_FUNCTION(call_int_void),
                        JS_FUNCTION(call_int_void_context), JS_FUNCTION(call_void_with_value),
                        JS_FUNCTION(call_void_error));
};

TEST_CASE("call_void_testRegular", "[function]")
{
...
struct CallErrorCheck
{
  ...
  JS_FUNCTION_CONTAINER(JS_FUNCTION(call_void), JS_FUNCTION(call_with_int), JS_FUNCTION(call_another_void),
...
TEST_CASE("call_error_checkRegular", "[function]")
{
...
struct JsonAlias
{
  ...
  JS_FUNCTION_CONTAINER(JS_FUNCTION(execute_one), JS_FUNCTION_ALIASES(execute_two_primary, "execute_two"),
                        JS_FUNCTION(execute_three));
};

TEST_CASE("call_json_aliasRegular", "[function]")
{
  JsonAlias cont;
  std::string json_out;
...
TEST_CASE("call_json_wrong_arg_typeRegular", "[function]")
{
