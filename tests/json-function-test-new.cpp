...
struct CallFunctionSub : public CallFunctionSuperSuper, public CallFunctionSuper
{
  ...
  bool called_three = false;
  JS_FUNC_OBJ_SUPER(JS_SUPER(CallFunctionSuperSuper, CallFunctionSuper), execute_three);
};

TEST_CASE("inheritanceTestShortNotation", "[function]")
{
...
TEST_CASE("virtualFunctionTestShortNotation", "[function]")
{
  std::string json_out;
...
TEST_CASE("super_class_param_testShortNotation", "[function]")
{
...
struct CallVoidStruct
{
  ...
  JS_FUNC_OBJ(call_void, call_void_context, call_int_void, call_int_void_context, call_void_with_value,
              call_void_error);
};

TEST_CASE("call_void_testShortNotation", "[function]")
{
...
struct CallErrorCheck
{
  ...
  JS_FUNC_OBJ(call_void, call_with_int, call_another_void, call_with_object);
...
TEST_CASE("call_error_checkShortNotation", "[function]")
{
...
TEST_CASE("call_json_aliasShortNotation", "[function]")
{
  JsonAlias cont;
  std::string json_out;
...
TEST_CASE("call_json_wrong_arg_typeShortNotation", "[function]")
{
