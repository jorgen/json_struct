...
#define LIST(SUBLIST, ...) \
    ...
    { \
        ...
        { \
            static auto list = SUBLIST; return list; \
        } \
...
struct Cover
{
	...
	//	}
	//	static decltype(std::make_tuple(makeElem("bar", &ELEMLIST_T::bar), makeElem("foo", &ELEMLIST_T::foo))) &getList()
	//	{
	//		static auto list = std::make_tuple(std::make_tuple(makeElem("bar", &ELEMLIST_T::bar), makeElem("foo", &ELEMLIST_T::foo))); return list;
	//	}
	//};
    LIST(SUB_LIST(
            SUB_ELEM(int),
